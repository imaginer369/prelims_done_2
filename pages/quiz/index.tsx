...
const quizOptions = [
  ...
  },
  {
    ...
    href: "/quiz/by-topic",
    icon: (
      <svg className="w-7 h-7 text-green-500 dark:text-green-300" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M8 12h8M12 8v8"/></svg>
    ),
  },
  {
