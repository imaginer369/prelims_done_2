...
export default function ConceptCard({ concept }: { concept: Concept }) {
  ...
  return (
    <div className="relative flex flex-col bg-white dark:bg-slate-900 border border-blue-200 dark:border-slate-700 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 group focus-within:ring-2 focus-within:ring-blue-400 min-h-[120px] text-black dark:text-white">
      <button
